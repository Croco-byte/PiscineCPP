...
/*   Updated: 2021/04/10 11:31:13 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string const & name): _name(name)
{
	...
	this->_hitPoints = 500;
	this->_maxHitPoints = 500;
	this->_energyPoints = 100;
	this->_maxEnergyPoints = 100;
	this->_level = 100;
	this->_meleeDmg = 100;
	this->_rangeDmg = 100;
	this->_armorReduction = 100;
}
...
{
	std::cout << std::endl;
	std::cout << "|name -> " << this->_name << "| |HP -> " << this->_hitPoints << "| |EP -> " << this->_energyPoints << "| |level -> " << this->_level << "| |melee -> " << this->_meleeDmg << "| |range -> " << this->_rangeDmg << "| |armor -> " << this->_armorReduction << "|" << std::endl;
	std::cout << std::endl;
}
...
void		ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (this->_hitPoints < 0)
		this->_hitPoints = 0;
	std::cout << "[" << this->_name << "]	takes " << amount - this->_armorReduction << " damage." << std::endl;
}
...
void		ClapTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << "[" << this->_name << "]	is repaired for " << amount << " HP." << std::endl;
}
