...
/*   Updated: 2021/04/14 14:04:28 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(AForm const & form)
{
	...
	{
		std::cout << this->_name << " can't execute form " << form.getName() << " because his grade is too low (bureaucrat grade " << this->_grade << ", form execution requires " << form.getExecGrade() << ")." << std::endl;
	}
	catch (std::exception &e)
	{
		std::cerr << e.what() << std::endl;
